        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublishYear = table.Column<DateTime>(nullable: true),
                    ListPrice = table.Column<int>(nullable: true),
                    Price = table.Column<int>(nullable: true),
                    Author = table.Column<string>(nullable: true),
                    CategoryId = table.Column<int>(nullable: true),
                    LanguageId = table.Column<string>(nullable: true),
                    LangaugeId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Books_Languages_LangaugeId",
